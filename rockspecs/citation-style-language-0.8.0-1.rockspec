...
+      local locale_file_format = "locales-%s.xml"
   ...
   modules = {
      ["citeproc-bibtex-data"] = "citeproc/citeproc-bibtex-data",
      ["citeproc-bibtex-parser"] = "citeproc/citeproc-bibtex-parser",
      ["citeproc-bibtex2csl"] = "citeproc/citeproc-bibtex2csl",
      ["citeproc-cli"] = "citeproc/citeproc-cli",
      ["citeproc-context"] = "citeproc/citeproc-context",
      ["citeproc-element"] = "citeproc/citeproc-element",
      ["citeproc-engine"] = "citeproc/citeproc-engine",
      ["citeproc-ir-node"] = "citeproc/citeproc-ir-node",
      ["citeproc-journal-data"] = "citeproc/citeproc-journal-data",
      ["citeproc-latex-data"] = "citeproc/citeproc-latex-data",
      ["citeproc-latex-parser"] = "citeproc/citeproc-latex-parser",
      ["citeproc-lua-uni-words"] = "citeproc/citeproc-lua-uni-words",
      ["citeproc-manager"] = "citeproc/citeproc-manager",
      ["citeproc-node-bibliography"] = "citeproc/citeproc-node-bibliography",
      ["citeproc-node-choose"] = "citeproc/citeproc-node-choose",
      ["citeproc-node-citation"] = "citeproc/citeproc-node-citation",
      ["citeproc-node-date"] = "citeproc/citeproc-node-date",
      ["citeproc-node-group"] = "citeproc/citeproc-node-group",
      ["citeproc-node-label"] = "citeproc/citeproc-node-label",
      ["citeproc-node-layout"] = "citeproc/citeproc-node-layout",
      ["citeproc-node-locale"] = "citeproc/citeproc-node-locale",
      ["citeproc-node-names"] = "citeproc/citeproc-node-names",
      ["citeproc-node-number"] = "citeproc/citeproc-node-number",
      ["citeproc-node-sort"] = "citeproc/citeproc-node-sort",
      ["citeproc-node-style"] = "citeproc/citeproc-node-style",
      ["citeproc-node-text"] = "citeproc/citeproc-node-text",
      ["citeproc-nodes"] = "citeproc/citeproc-nodes",
      ["citeproc-output"] = "citeproc/citeproc-output",
      ["citeproc-unicode"] = "citeproc/citeproc-unicode",
      ["citeproc-util"] = "citeproc/citeproc-util",
      ["citeproc-yaml"] = "citeproc/citeproc-yaml",
      ["citeproc"] = "citeproc/citeproc",
   }
}
test_dependencies = {
   "dkjson >= 2.1.0",
