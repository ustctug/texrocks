...
local function get_parser()
    ...
    local cmd = parser:command("run", "run luatex/lualatex/... with correct environment variables")
    cmd:option("--short", "use short path in " .. constants.fontmap_name):args(0)
    cmd:argument("args", "arguments"):args "*"
